...
const mailOptions = {
  from: 'your_email@provider.com', // Replace with your email addressto: 'recipient@example.com', // Replace with the recipient's email addresssubject: 'User Information', // Replace with your desired subjecthtml: `
    <!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
